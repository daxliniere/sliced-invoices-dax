		...
		<div id="sliced-email-popup" style="display:none;">
			<div class="sliced-email-preview">
				...
				<div class="nav-tab-wrapper sliced-email-preview-menu" style="display:none;">
					...
					<a class="nav-tab" data-sliced-email-template="invoice_update" onclick="sliced_invoices.sliced_email_preview_switch('invoice_update')">Updated Invoice Available</a>
